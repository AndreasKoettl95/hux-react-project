...
switch(item) {
    case "System": return <System user={props.user} RefreshDesktopColor={props.RefreshDesktopColor}/>
    case "Time": return <Time />
    case "Apps": return <Apps /> 
    case "Accounts": return <Accounts user={props.user} password={props.password} bgColor={ props.bgColor}/>
